...
public class AdminloginBtask extends AsyncTask<String,Void,String> {
    Context ctx;
    ProgressDialog progressDialog;
    Activity activity;
    AlertDialog.Builder builder;
    String upload_url="http://192.168.43.145/Adminlogin.php";
...
//    public static final String upload_key
    ...
    public AdminloginBtask(Context ctx){
        this.ctx=ctx;
            ...
            try {
             //Toast.makeText(ctx,json,Toast.LENGTH_LONG).show();
                ...
                if (code.equals("login_true")) {
                    ...
                    session = new AdminSessionManager(ctx);
                    session.createUserLoginSession("id");

                   Intent intent = new Intent(ctx,Admin.class);
                    ...
                    builder.setTitle("Error!!! Login Failed...");
                    builder.setMessage("You Entered wrong Credentials. Check your details and try agin \n");
                    builder.setPositiveButton("Try Again", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.dismiss();
                    ...
                    }).setNegativeButton("Not registerd?.", new DialogInterface.OnClickListener() {
                        @Override
