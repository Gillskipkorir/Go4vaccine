...
public class adddocBTask extends AsyncTask<String,Void,String> {
Context ctx;
ProgressDialog progressDialog;
Activity activity;
AlertDialog.Builder builder;
String upload_url="http://192.168.43.145/docdetails.php";
    ...
    String idno="idno";
    String pass="pass";
public adddocBTask(Context ctx){
    this.ctx=ctx;
...
protected void onPostExecute(String json) {
    if (json == null) {
        ...
        builder.setMessage("Failed Register New Doctor..........\nCheck Your internet Connection.");
