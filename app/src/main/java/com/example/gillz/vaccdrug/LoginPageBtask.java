...
public class LoginPageBtask extends AsyncTask<String,Void,String> {
    ...
    String upload_url="http://192.168.43.222/Dlogin.php";
...
//    public static final String upload_key
    ...
    protected void onPostExecute(String json) {
        if (json == null) {
            ...
            }).setNegativeButton("Contact Admin.", new DialogInterface.OnClickListener() {
                @Override
            ...
            try {
             //Toast.makeText(ctx,json,Toast.LENGTH_LONG).show();
                ...
                if (code.equals("login_true")) {
                   ...
                   Intent intent = new Intent(ctx,Doctor.class);
